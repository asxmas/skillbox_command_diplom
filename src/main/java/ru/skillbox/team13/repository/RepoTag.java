...
public class RepoTag implements Repo<Tag> {

  @Override
  public void addToRepo(Tag tag) {

  }

  @Override
  public void removeFromRepo(Tag tag) {
  ...
  @Override
  public <S extends Tag> List<S> saveAllAndFlush(Iterable<S> iterable) {
    return null;
  }

  @Override
  public void deleteAllInBatch(Iterable<Tag> iterable) {
